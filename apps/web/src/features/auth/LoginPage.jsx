...
export function LoginPage() {
  ...
  return (
    ...
    >
      ...
      {/* --- SLOW-MOTION INTERACTIVE 3D BLURRED BUBBLES (ZERO BOUNDARIES) --- */}
      ...
      <motion.div
        ...
        style={{
          transform: `translate3d(${mousePos.x * 80}px, ${mousePos.y * 80}px, 0px)`,
        }}
      ...
      <motion.div
        ...
        style={{
          transform: `translate3d(${mousePos.x * 65}px, ${mousePos.y * -65}px, 0px)`,
        }}
        className="absolute bottom-[5%] left-[5%] w-[480px] h-[480px] rounded-full blur-[160px] bg-gradient-to-br from-amber-400/40 via-orange-300/35 to-yellow-500/25 dark:from-amber-500/30 dark:via-orange-950/25 dark:to-slate-950/25 pointer-events-none transition-transform duration-700 ease-out"
      />
      ...
      <motion.div
        ...
        className="absolute top-[35%] left-[38%] w-[450px] h-[450px] rounded-full blur-[160px] bg-gradient-to-br from-emerald-400/40 via-teal-300/35 to-green-500/25 dark:from-emerald-500/30 dark:via-teal-900/25 dark:to-slate-950/25 pointer-events-none transition-transform duration-700 ease-out"
      />
      ...
      {/* Main 3D Container Section (Apple Liquid Glassmorphism) */}
      <motion.section 
        initial={{ opacity: 0, y: 20, scale: 0.98 }}
        animate={{ opacity: 1, y: 0, scale: 1 }}
        transition={{ duration: 0.6, ease: [0.16, 1, 0.3, 1] }}
        style={{
          transform: `translate3d(${mousePos.x * 14}px, ${mousePos.y * 14}px, 0px)`,
        }}
